...
public class class250 {
   ...
   public static HashTable NetCache_pendingPriorityWrites = new HashTable(4096);
   @ObfuscatedName("f")
   @ObfuscatedGetter(
      intValue = -957679387
   )
   ...
   public static HashTable NetCache_pendingPriorityResponses = new HashTable(32);
   @ObfuscatedName("h")
   @ObfuscatedGetter(
      intValue = 832714855
   )
   ...
   public static Node2LinkedList NetCache_pendingWritesQueue = new Node2LinkedList();
   @ObfuscatedName("j")
   @ObfuscatedSignature(
      signature = "Lgd;"
   )
   @Export("NetCache_pendingWrites")
   public static HashTable NetCache_pendingWrites = new HashTable(4096);
   @ObfuscatedName("a")
   @ObfuscatedGetter(
      intValue = 1476715115
   )
   ...
   public static HashTable NetCache_pendingResponses = new HashTable(4096);
   @ObfuscatedName("d")
   @ObfuscatedGetter(
      intValue = 1943132599
   )
   ...
   static IndexData[] NetCache_indexCaches = new IndexData[256];
   @ObfuscatedName("z")
   public static byte field3225 = 0;
   @ObfuscatedName("k")
   @ObfuscatedGetter(
      intValue = -423946815
   )
