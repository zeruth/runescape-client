...
public final class PacketBuffer extends Buffer {
   @ObfuscatedName("a")
   static final int[] field2397 = new int[]{0, 1, 3, 7, 15, 31, 63, 127, 255, 511, 1023, 2047, 4095, 8191, 16383, 32767, 65535, 131071, 262143, 524287, 1048575, 2097151, 4194303, 8388607, 16777215, 33554431, 67108863, 134217727, 268435455, 536870911, 1073741823, Integer.MAX_VALUE, -1};
   @ObfuscatedName("bb")
   @ObfuscatedSignature(
      signature = "[Llh;"
   )
         ...
         if (var5 == 22) {
            ...
            if (var5 != 10 && var5 != 11) {
               if (var5 >= 12) {
                  ...
                  Object var30;
                  if (var8.animationId == -1 && var8.impostorIds == null) {
                     var30 = var8.getModel(2, var4 + 4, var15, var17, var16, var18);
                     var26 = var8.getModel(2, var24, var15, var17, var16, var18);
                  } else {
                     var30 = new DynamicObject(var3, 2, var4 + 4, var0, var1, var2, var8.animationId, true, (Renderable)null);
                     var26 = new DynamicObject(var3, 2, var24, var0, var1, var2, var8.animationId, true, (Renderable)null);
                  }

                  var6.addBoundary(var0, var1, var2, var16, (Renderable)var30, (Renderable)var26, class50.field454[var4], class50.field454[var24], var19, var21);
                  if (var8.modelClipped) {
                     if (var4 == 0) {
                        MouseRecorder.field534[var0][var1][var2] |= 585;
                  ...
                  if (var5 == 5) {
                     ...
                     if (var31 != 0L) {
                        var24 = SoundTaskDataProvider.getObjectDefinition(class8.method93(var31)).decorDisplacement;
                     }

                     if (var8.animationId == -1 && var8.impostorIds == null) {
                        var27 = var8.getModel(4, var4, var15, var17, var16, var18);
                     } else {
                        var27 = new DynamicObject(var3, 4, var4, var0, var1, var2, var8.animationId, true, (Renderable)null);
                     }

                     var6.addBoundaryDecoration(var0, var1, var2, var16, (Renderable)var27, (Renderable)null, class50.field454[var4], 0, var24 * class50.field456[var4], var24 * class50.field457[var4], var19, var21);
                  } else if (var5 == 6) {
                     var24 = 8;
                     var31 = var6.method2927(var0, var1, var2);
                     if (0L != var31) {
                        var24 = SoundTaskDataProvider.getObjectDefinition(class8.method93(var31)).decorDisplacement / 2;
                     }

                     if (var8.animationId == -1 && var8.impostorIds == null) {
                        var27 = var8.getModel(4, var4 + 4, var15, var17, var16, var18);
                     } else {
                        var27 = new DynamicObject(var3, 4, var4 + 4, var0, var1, var2, var8.animationId, true, (Renderable)null);
                     }

                     var6.addBoundaryDecoration(var0, var1, var2, var16, (Renderable)var27, (Renderable)null, 256, var4, var24 * class50.field458[var4], var24 * class50.field459[var4], var19, var21);
                  } else if (var5 == 7) {
                     var23 = var4 + 2 & 3;
                     if (var8.animationId == -1 && var8.impostorIds == null) {
                     ...
                     if (var8.animationId == -1 && var8.impostorIds == null) {
                        var27 = var8.getModel(4, var4 + 4, var15, var17, var16, var18);
                        var29 = var8.getModel(4, var28 + 4, var15, var17, var16, var18);
                     } else {
                        var27 = new DynamicObject(var3, 4, var4 + 4, var0, var1, var2, var8.animationId, true, (Renderable)null);
                        var29 = new DynamicObject(var3, 4, var28 + 4, var0, var1, var2, var8.animationId, true, (Renderable)null);
                     }

                     var6.addBoundaryDecoration(var0, var1, var2, var16, (Renderable)var27, (Renderable)var29, 256, var4, var24 * class50.field458[var4], var24 * class50.field459[var4], var19, var21);
                  }
               }
            } else {
               if (var8.animationId == -1 && var8.impostorIds == null) {
