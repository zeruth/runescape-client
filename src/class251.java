...
public class class251 {
   ...
   @ObfuscatedName("w")
   final HashMap field3240 = new HashMap();
   @ObfuscatedName("m")
   @ObfuscatedSignature(
      signature = "Lka;"
   )
   class310 field3231 = new class310(0, 0);
   @ObfuscatedName("q")
   int[] field3237 = new int[2048];
   @ObfuscatedName("b")
   int[] field3232 = new int[2048];
   @ObfuscatedName("f")
   @ObfuscatedGetter(
      intValue = 1614131407
   )
   ...
   void method4786(int var1) {
      ...
      class318 var18 = new class318(var17, var2, var2);
   ...
   class318 method4788(int var1) {
      if(!this.field3240.containsKey(Integer.valueOf(var1))) {
         this.method4786(var1);
      }

      return (class318)this.field3240.get(Integer.valueOf(var1));
   }
   ...
   public final void method4789(int var1, int var2, class318 var3, float var4) {
      int var5 = (int)(var4 * 18.0F);
      class318 var6 = this.method4788(var5);
      int var7 = var5 * 2 + 1;
      class310 var8 = new class310(0, 0, var3.field3794, var3.field3801);
      ...
      for(var10 = 0; var10 < this.field3233; ++var10) {
         ...
         int var14 = (int)((float)var3.field3801 - (float)(var12 - var2) * var4) - var5;
      ...
      for(var10 = 0; var10 < var3.field3798.length; ++var10) {
         if(var3.field3798[var10] == 0) {
            var3.field3798[var10] = -16777216;
         } else {
            var11 = (var3.field3798[var10] + 64 - 1) / 256;
            if(var11 <= 0) {
               var3.field3798[var10] = -16777216;
            } else {
               ...
               var3.field3798[var10] = -16777216 | var12;
            }
         }
      }
   ...
   void method4790(class318 var1, class318 var2, class310 var3) {
      if(var3.field3750 != 0 && var3.field3751 != 0) {
         ...
         int var5 = 0;
         if(var3.field3752 == 0) {
            var4 = var1.field3794 - var3.field3750;
         }

         if(var3.field3749 == 0) {
            var5 = var1.field3801 - var3.field3751;
         }

         int var6 = var4 + var5 * var1.field3794;
         int var7 = var2.field3794 * var3.field3749 + var3.field3752;

         for(int var8 = 0; var8 < var3.field3751; ++var8) {
            for(int var9 = 0; var9 < var3.field3750; ++var9) {
               int var10001 = var7++;
               var2.field3798[var10001] += var1.field3798[var6++];
            }

            var6 += var1.field3794 - var3.field3750;
            var7 += var2.field3794 - var3.field3750;
         }
