...
public class Widget extends Node {
   ...
   public static NodeCache field2617 = new NodeCache(200);
   @ObfuscatedName("s")
   @ObfuscatedSignature(
      signature = "Lgj;"
   )
   @Export("Widget_cachedModels")
   public static NodeCache Widget_cachedModels = new NodeCache(50);
   @ObfuscatedName("p")
   @ObfuscatedSignature(
      signature = "Lgj;"
   )
   @Export("Widget_cachedFonts")
   public static NodeCache Widget_cachedFonts = new NodeCache(20);
   @ObfuscatedName("g")
   @ObfuscatedSignature(
      signature = "Lgj;"
   )
   public static NodeCache field2620 = new NodeCache(8);
   @ObfuscatedName("y")
   ...
   public Font getFont() {
      ...
      if (this.fontId == -1) {
         ...
         if (var1 != null) {
            ...
            IndexDataBase var2 = KeyFocusListener.field354;
            IndexDataBase var3 = class217.field2489;
            ...
            if (var5 != null) {
               Widget_cachedFonts.put(var5, (long)this.fontId);
            } else {
               field2621 = true;
            }
      ...
      if (var2 == 0) {
         ...
         if (Client.cachedPlayers[var1] != null) {
            ...
            if (class81.field1179[var1] != null) {
               var12.decodeApperance(class81.field1179[var1]);
            }

            var12.orientation = class81.Players_orientations[var1];
            var12.interacting = class81.Players_targetIndices[var1];
            var5 = class81.Players_regions[var1];
            var6 = var5 >> 28;
            var7 = var5 >> 14 & 255;
            var8 = var5 & 255;
            var12.pathTraversed[0] = class81.field1177[var1];
            var12.field581 = (byte)var6;
            var12.method1173((var7 << 13) + var3 - class178.baseX, (var8 << 13) + var4 - CombatInfoListHolder.baseY);
            var12.field586 = false;
            return true;
         }
      } else if (var2 == 1) {
         var3 = var0.getBits(2);
         ...
         if (var2 == 2) {
            ...
            var4 = var3 >> 3;
            var9 = var3 & 7;
            var10 = class81.Players_regions[var1];
            ...
            class81.Players_regions[var1] = (var6 << 14) + var7 + (var5 << 28);
            return false;
         } else {
            ...
            var8 = var10 + var5 & 255;
            class81.Players_regions[var1] = (var7 << 14) + var8 + (var6 << 28);
            return false;
         }
      }
   }
   ...
   static final void draw2DExtras(Actor var0, int var1, int var2, int var3, int var4, int var5) {
      if (var0 != null && var0.hasConfig()) {
         ...
         int var76 = class81.playerIndexesCount;
         int[] var7 = class81.playerIndices;
         byte var8 = 0;
         if (var1 < var76 && var0.field905 == Client.gameCycle && class171.method3469((Player)var0)) {
         ...
         if (!var0.combatInfoList.isEmpty()) {
            ...
            for(CombatInfoListHolder var13 = (CombatInfoListHolder)var0.combatInfoList.last(); var13 != null; var13 = (CombatInfoListHolder)var0.combatInfoList.previous()) {
               CombatInfo1 var14 = var13.method1816(Client.gameCycle);
               if (var14 == null) {
                  if (var13.method1817()) {
                     var13.unlink();
                  }
               } else {
                  CombatInfo2 var15 = var13.combatInfo2;
                  SpritePixels var16 = var15.method4929();
                  SpritePixels var17 = var15.method4928();
                  int var18 = 0;
                  if (var16 != null && var17 != null) {
                     if (var15.field3334 * 2 < var17.width) {
                        var18 = var15.field3334;
                     }

                     var78 = var17.width - var18 * 2;
                  } else {
                     var78 = var15.healthScale;
                  }

                  int var19 = 255;
                  boolean var20 = true;
                  int var21 = Client.gameCycle - var14.cycle;
                  int var22 = var78 * var14.health / var15.healthScale;
                  if (var14.int2 > var21) {
                     var23 = var15.field3321 == 0 ? 0 : var15.field3321 * (var21 / var15.field3321);
                     var79 = var78 * var14.healthRatio / var15.healthScale;
                     var24 = var23 * (var22 - var79) / var14.int2 + var79;
                  } else {
                     var24 = var22;
                     var23 = var14.int2 + var15.field3330 - var21;
                     if (var15.field3328 >= 0) {
                        var19 = (var23 << 8) / (var15.field3330 - var15.field3328);
                     }
                  }

                  if (var14.health > 0 && var24 < 1) {
                     var24 = 1;
                  }
                  ...
                  if (var16 != null && var17 != null) {
                     ...
                     var23 = var16.height;
                     var77 += var23;
                     var79 = var2 + Client.screenX - (var78 >> 1);
                     var12 = var3 + Client.screenY - var77;
                     var79 -= var18;
                     if (var19 >= 0 && var19 < 255) {
                        var16.drawAtOpacity(var79, var12, var19);
                        Rasterizer2D.setInnerDrawRegion(var79, var12, var24 + var79, var23 + var12);
                        var17.drawAtOpacity(var79, var12, var19);
                     } else {
                        var16.drawAt(var79, var12);
                        Rasterizer2D.setInnerDrawRegion(var79, var12, var24 + var79, var23 + var12);
                        var17.drawAt(var79, var12);
                     }
                     ...
                     var77 += 5;
                     if (Client.screenX > -1) {
                        var23 = var2 + Client.screenX - (var78 >> 1);
                        var79 = var3 + Client.screenY - var77;
                        Rasterizer2D.Rasterizer2D_fillRectangle(var23, var79, var24, 5, 65280);
                        Rasterizer2D.Rasterizer2D_fillRectangle(var24 + var23, var79, var78 - var24, 5, 16711680);
                     }
         ...
         var77 += var8;
         if (var1 < var76) {
            Player var82 = (Player)var0;
            if (var82.hidden) {
               return;
            }

            if (var82.skullIcon != -1 || var82.overheadIcon != -1) {
               class11.characterToScreen(var0, var0.logicalHeight + 15);
               if (Client.screenX > -1) {
                  if (var82.skullIcon != -1) {
                     var77 += 25;
                     Actor.headIconsPk[var82.skullIcon].drawAt(var2 + Client.screenX - 12, var3 + Client.screenY - var77);
                  }

                  if (var82.overheadIcon != -1) {
                     var77 += 25;
                     KeyFocusListener.headIconsPrayer[var82.overheadIcon].drawAt(var2 + Client.screenX - 12, var3 + Client.screenY - var77);
                  }
               }
            }
            ...
            if (var1 >= 0 && Client.hintArrowTargetType == 10 && var7[var1] == Client.hintArrowPlayerTargetIdx) {
               class11.characterToScreen(var0, var0.logicalHeight + 15);
               if (Client.screenX > -1) {
                  var77 += class262.headIconsHint[1].height;
                  class262.headIconsHint[1].drawAt(var2 + Client.screenX - 12, var3 + Client.screenY - var77);
               }
            }
         } else {
            NPCComposition var80 = ((NPC)var0).composition;
            if (var80.configs != null) {
               var80 = var80.transform();
            }

            if (var80.headIcon >= 0 && var80.headIcon < KeyFocusListener.headIconsPrayer.length) {
               class11.characterToScreen(var0, var0.logicalHeight + 15);
               if (Client.screenX > -1) {
                  KeyFocusListener.headIconsPrayer[var80.headIcon].drawAt(var2 + Client.screenX - 12, var3 + Client.screenY - 30);
               }
            }

            if (Client.hintArrowTargetType == 1 && Client.npcIndices[var1 - var76] == Client.hintArrowNpcTargetIdx && Client.gameCycle % 20 < 10) {
               class11.characterToScreen(var0, var0.logicalHeight + 15);
               if (Client.screenX > -1) {
         ...
         if (var0.overhead != null && (var1 >= var76 || !var0.field941 && (Client.publicChatMode == 4 || !var0.field938 && (Client.publicChatMode == 0 || Client.publicChatMode == 3 || Client.publicChatMode == 1 && ((Player)var0).isFriend())))) {
         ...
         for(int var83 = 0; var83 < 4; ++var83) {
            int var81 = var0.hitsplatCycles[var83];
            int var84 = var0.hitsplatTypes[var83];
            class267 var85 = null;
            int var86 = 0;
            if (var84 >= 0) {
               ...
               var85 = class8.method92(var0.hitsplatTypes[var83]);
               var86 = var85.field3375;
               if (var85 != null && var85.field3383 != null) {
                  var85 = var85.method5016();
                  if (var85 == null) {
                     var0.hitsplatCycles[var83] = -1;
                     continue;
                  }
               }
            } else if (var81 < 0) {
            ...
            var78 = var0.field906[var83];
            class267 var87 = null;
            if (var78 >= 0) {
               var87 = class8.method92(var78);
               if (var87 != null && var87.field3383 != null) {
                  var87 = var87.method5016();
               }
            }

            if (var81 - var86 <= Client.gameCycle) {
               if (var85 == null) {
                  var0.hitsplatCycles[var83] = -1;
               } else {
                  ...
                  if (Client.screenX > -1) {
                     ...
                     Font var43 = var85.method5017();
                     if (var43 == null) {
                        var43 = LoginPacket.fontPlain11;
                     }

                     Font var44;
                     if (var87 != null) {
                        var44 = var87.method5017();
                        if (var44 == null) {
                     ...
                     boolean var47 = false;
                     int var48 = 0;
                     var45 = var85.method5013(var0.hitsplatValues[var83]);
                     int var49 = var43.getTextWidth(var45);
                     if (var87 != null) {
                        var46 = var87.method5013(var0.field907[var83]);
                     ...
                     var63 = var0.hitsplatCycles[var83] - Client.gameCycle;
                     int var64 = var85.field3371 - var63 * var85.field3371 / var85.field3375;
                     int var65 = var63 * var85.field3381 / var85.field3375 + -var85.field3381;
                     int var66 = var64 + (var2 + Client.screenX - (var52 >> 1));
                     int var67 = var65 + (var3 + Client.screenY - 12);
                     int var68 = var67;
                     int var69 = var67 + var41;
                     int var70 = var67 + var85.field3385 + 15;
                     int var71 = var70 - var43.minSpacing;
                     int var72 = var70 + var43.maxSpacing;
                     if (var71 < var67) {
                        var68 = var71;
                     }
                     ...
                     int var75;
                     if (var87 != null) {
                        var73 = var67 + var87.field3385 + 15;
                        var74 = var73 - var44.minSpacing;
                        var75 = var73 + var44.maxSpacing;
                        if (var74 < var68) {
                           ;
                        }
                     ...
                     var74 = 255;
                     if (var85.field3370 >= 0) {
                        var74 = (var63 << 8) / (var85.field3375 - var85.field3370);
                     }

                     if (var74 >= 0 && var74 < 255) {
                        if (var88 != null) {
                           var88.drawAtOpacity(var66 + var53 - var25, var67, var74);
                        }

                        if (var90 != null) {
                           var90.drawAtOpacity(var54 + var66 - var27, var67, var74);
                        }

                        if (var89 != null) {
                           for(var75 = 0; var75 < var50; ++var75) {
                              var89.drawAtOpacity(var12 * var75 + (var66 + var55 - var26), var67, var74);
                           }
                        }

                        if (var91 != null) {
                           var91.drawAtOpacity(var57 + var66 - var28, var67, var74);
                        }

                        var43.method5542(var45, var66 + var56, var70, var85.field3374, 0, var74);
                        if (var87 != null) {
                           if (var29 != null) {
                              var29.drawAtOpacity(var58 + var66 - var37, var67, var74);
                           }

                           if (var31 != null) {
                              var31.drawAtOpacity(var59 + var66 - var39, var67, var74);
                           }

                           if (var30 != null) {
                              for(var75 = 0; var75 < var51; ++var75) {
                                 var30.drawAtOpacity(var34 * var75 + (var66 + var60 - var38), var67, var74);
                              }
                           }

                           if (var32 != null) {
                              var32.drawAtOpacity(var66 + var61 - var40, var67, var74);
                           }

                           var44.method5542(var46, var66 + var62, var73, var87.field3374, 0, var74);
                        }
                     } else {
                        if (var88 != null) {
                           var88.drawAt(var66 + var53 - var25, var67);
                        }

                        if (var90 != null) {
                           var90.drawAt(var54 + var66 - var27, var67);
                        }

                        if (var89 != null) {
                           for(var75 = 0; var75 < var50; ++var75) {
                              var89.drawAt(var75 * var12 + (var66 + var55 - var26), var67);
                           }
                        }

                        if (var91 != null) {
                           var91.drawAt(var57 + var66 - var28, var67);
                        }

                        var43.method5541(var45, var56 + var66, var70, var85.field3374 | -16777216, 0);
                        if (var87 != null) {
                           if (var29 != null) {
                              var29.drawAt(var66 + var58 - var37, var67);
                           }

                           if (var31 != null) {
                              var31.drawAt(var59 + var66 - var39, var67);
                           }

                           if (var30 != null) {
                              for(var75 = 0; var75 < var51; ++var75) {
                                 var30.drawAt(var34 * var75 + (var66 + var60 - var38), var67);
                              }
                           }

                           if (var32 != null) {
                              var32.drawAt(var61 + var66 - var40, var67);
                           }

                           var44.method5541(var46, var62 + var66, var73, var87.field3374 | -16777216, 0);
                        }
                     }
                  }
               }
   ...
   static final void method4537(int var0) {
      ...
      int var6 = var2.configType;
      if (var6 != 0) {
         int var4 = class225.clientVarps[var0];
         if (var6 == 1) {
            if (var4 == 1) {
         ...
         if (var6 == 3) {
            ...
            if (var5 != Client.field693) {
               if (Client.field693 == 0 && Client.field824 != -1) {
                  class179.method3537(MouseInput.indexTrack1, Client.field824, 0, var5, false);
                  Client.field825 = false;
               } else if (var5 == 0) {
                  class37.method721();
                  Client.field825 = false;
               } else {
                  PendingSpawn.method1578(var5);
               }

               Client.field693 = var5;
            }
         }
         ...
         if (var6 == 17) {
            Client.field760 = var4 & '\uffff';
         }

         if (var6 == 18) {
            Client.playerAttackOption = (AttackOption)class7.forOrdinal(class26.method471(), var4);
         ...
         if (var6 == 19) {
            if (var4 == -1) {
               ...
               Client.field719 = var4 & 2047;
            }
         }

         if (var6 == 22) {
            Client.npcAttackOption = (AttackOption)class7.forOrdinal(class26.method471(), var4);
