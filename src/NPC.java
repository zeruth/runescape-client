...
public final class NPC extends Actor {
   ...
   protected final Model getModel() {
      if(this.composition == null) {
         ...
         Sequence var2 = super.poseAnimation == -1 || super.idlePoseAnimation == super.poseAnimation && var1 != null?null:class137.getAnimation(super.poseAnimation);
   ...
   static void method1841(IndexDataBase var0, IndexDataBase var1, boolean var2, int var3) {
      if(class78.field1122) {
         ...
         class8.field51 = new int[32768];
         class83.field1206 = new int[32768];
         class43.method790((IndexedSprite)null);
         class297.field3701 = new int[32768];
         class274.field3569 = new int[32768];
         if(var2) {
            class78.username = "";
            class78.password = "";
         }
         ...
         if(!ScriptState.preferences.muted) {
            IndexData var6 = MouseInput.indexTrack1;
            int var7 = var6.getFile("scape main");
            int var8 = var6.getChild(var7, "");
            ClientPacket.method3459(2, var6, var7, var8, 255, false);
         } else {
