...
public class FontName {
   ...
   public static final FontName FontName_plain11 = new FontName("PLAIN11", "p11_full");
   @ObfuscatedName("m")
   @ObfuscatedSignature(
      signature = "Lkt;"
   )
   @Export("FontName_plain12")
   public static final FontName FontName_plain12 = new FontName("PLAIN12", "p12_full");
   @ObfuscatedName("q")
   @ObfuscatedSignature(
      signature = "Lkt;"
   )
   @Export("FontName_bold12")
   public static final FontName FontName_bold12 = new FontName("BOLD12", "b12_full");
   @ObfuscatedName("b")
   @ObfuscatedSignature(
      signature = "Lkt;"
   )
   public static final FontName field3682 = new FontName("VERDANA11", "verdana_11pt_regular");
   @ObfuscatedName("f")
   @ObfuscatedSignature(
      signature = "Lkt;"
   )
   public static final FontName field3683 = new FontName("VERDANA13", "verdana_13pt_regular");
   @ObfuscatedName("n")
   @ObfuscatedSignature(
      signature = "Lkt;"
   )
   public static final FontName field3684 = new FontName("VERDANA15", "verdana_15pt_regular");
   @ObfuscatedName("ig")
   @ObfuscatedSignature(
      signature = "Lhl;"
   )
