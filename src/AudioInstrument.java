...
public class AudioInstrument {
   ...
   AudioInstrument() {
      this.oscillatorVolume = new int[5];
      this.oscillatorPitch = new int[5];
      this.oscillatorDelays = new int[5];
      this.delayTime = 0;
      this.delayDecay = 100;
      this.duration = 500;
      this.offset = 0;
         ...
         if(this.filter.pairs[0] > 0 || this.filter.pairs[1] > 0) {
            ...
            if(var1 >= var12 + var13) {
               ...
               while(true) {
                  ...
                  int var20;
                  while(var14 < var15) {
                     var19 = (int)((long)samples[var14 + var12] * (long)SoundEffect3.fowardMultiplier >> 16);

                     for(var20 = 0; var20 < var12; ++var20) {
                        var19 += (int)((long)samples[var14 + var12 - 1 - var20] * (long)SoundEffect3.coefficients[0][var20] >> 16);
                     }
