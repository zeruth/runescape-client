...
public class class32 {
   ...
   void method587(int var1, int var2, int var3, FloorUnderlayDefinition var4) {
      if (var4 != null && var3 + var1 >= 0 && var3 + var2 >= 0 && var1 - var3 <= this.field285 && var2 - var3 <= this.field282) {
   ...
   static void drawLoginScreen(Font var0, Font var1, Font var2, boolean var3) {
      ...
      if (class78.worldSelectShown) {
         ...
         if (Client.gameState == 0 || Client.gameState == 5) {
            byte var5 = 20;
            var0.drawTextCentered("RuneScape is loading - please wait...", class78.loginWindowX + 180, 245 - var5, 16777215, -1);
            var4 = 253 - var5;
            Rasterizer2D.drawRectangle(class78.loginWindowX + 180 - 152, var4, 304, 34, 9179409);
            Rasterizer2D.drawRectangle(class78.loginWindowX + 180 - 151, var4 + 1, 302, 32, 0);
            Rasterizer2D.Rasterizer2D_fillRectangle(class78.loginWindowX + 180 - 150, var4 + 2, class78.loadingBarPercentage * 3, 30, 9179409);
            Rasterizer2D.Rasterizer2D_fillRectangle(class78.loadingBarPercentage * 3 + (class78.loginWindowX + 180 - 150), var4 + 2, 300 - class78.loadingBarPercentage * 3, 30, 0);
            var0.drawTextCentered(class78.loadingText, class78.loginWindowX + 180, 276 - var5, 16777215, -1);
         }
         ...
         if (Client.gameState == 20) {
            ...
            var6 = 201;
            var0.drawTextCentered(class78.loginMessage1, class78.loginWindowX + 180, var6, 16776960, 0);
            var7 = var6 + 15;
            var0.drawTextCentered(class78.loginMessage2, class78.loginWindowX + 180, var7, 16776960, 0);
            var7 += 15;
            var0.drawTextCentered(class78.loginMessage3, class78.loginWindowX + 180, var7, 16776960, 0);
            var7 += 15;
            var7 += 7;
            if (class78.loginIndex != 4) {
               var0.method5541("Login: ", class78.loginWindowX + 180 - 110, var7, 16777215, 0);
               var8 = 200;

               for(var15 = MouseRecorder.method1085(); var0.getTextWidth(var15) > var8; var15 = var15.substring(0, var15.length() - 1)) {
                  ;
               }

               var0.method5541(FontTypeFace.appendTags(var15), class78.loginWindowX + 180 - 70, var7, 16777215, 0);
               var7 += 15;
               var0.method5541("Password: " + TextureProvider.method2592(class78.password), class78.loginWindowX + 180 - 108, var7, 16777215, 0);
               var7 += 15;
            }
         }
         ...
         if (Client.gameState == 10 || Client.gameState == 11) {
            ...
            if (class78.loginIndex == 0) {
               var6 = 251;
               var0.drawTextCentered("Welcome to RuneScape", class78.loginWindowX + 180, var6, 16776960, 0);
               var7 = var6 + 30;
               var4 = class78.loginWindowX + 180 - 80;
               var9 = 291;
               class78.field1113.method5873(var4 - 73, var9 - 20);
               var0.method5595("New User", var4 - 73, var9 - 20, 144, 40, 16777215, 0, 1, 1, 0);
               var4 = class78.loginWindowX + 180 + 80;
               class78.field1113.method5873(var4 - 73, var9 - 20);
               var0.method5595("Existing User", var4 - 73, var9 - 20, 144, 40, 16777215, 0, 1, 1, 0);
            } else if (class78.loginIndex == 1) {
               var0.drawTextCentered(class78.Login_response0, class78.loginWindowX + 180, 201, 16776960, 0);
               var6 = 236;
               var0.drawTextCentered(class78.loginMessage1, class78.loginWindowX + 180, var6, 16777215, 0);
               var7 = var6 + 15;
               var0.drawTextCentered(class78.loginMessage2, class78.loginWindowX + 180, var7, 16777215, 0);
               var7 += 15;
               var0.drawTextCentered(class78.loginMessage3, class78.loginWindowX + 180, var7, 16777215, 0);
               var7 += 15;
               var4 = class78.loginWindowX + 180 - 80;
               var9 = 321;
               class78.field1113.method5873(var4 - 73, var9 - 20);
               var0.drawTextCentered("Continue", var4, var9 + 5, 16777215, 0);
               var4 = class78.loginWindowX + 180 + 80;
               class78.field1113.method5873(var4 - 73, var9 - 20);
               var0.drawTextCentered("Cancel", var4, var9 + 5, 16777215, 0);
            } else {
               int var10;
               if (class78.loginIndex == 2) {
                  var6 = 201;
                  var0.drawTextCentered(class78.loginMessage1, class78.field1112, var6, 16776960, 0);
                  var7 = var6 + 15;
                  var0.drawTextCentered(class78.loginMessage2, class78.field1112, var7, 16776960, 0);
                  var7 += 15;
                  var0.drawTextCentered(class78.loginMessage3, class78.field1112, var7, 16776960, 0);
                  var7 += 15;
                  var7 += 7;
                  var0.method5541("Login: ", class78.field1112 - 110, var7, 16777215, 0);
                  var8 = 200;

                  for(var15 = MouseRecorder.method1085(); var0.getTextWidth(var15) > var8; var15 = var15.substring(1)) {
                     ;
                  }

                  var0.method5541(FontTypeFace.appendTags(var15) + (class78.currentLoginField == 0 & Client.gameCycle % 40 < 20 ? class50.getColTags(16776960) + "|" : ""), class78.field1112 - 70, var7, 16777215, 0);
                  var7 += 15;
                  var0.method5541("Password: " + TextureProvider.method2592(class78.password) + (class78.currentLoginField == 1 & Client.gameCycle % 40 < 20 ? class50.getColTags(16776960) + "|" : ""), class78.field1112 - 108, var7, 16777215, 0);
                  var7 += 15;
                  var6 = 277;
                  var10 = class78.field1112 + -117;
                  IndexedSprite var18 = GrandExchangeOffer.method54(class78.Login_isUsernameRemembered, class78.field1133);
                  var18.method5873(var10, var6);
                  var10 = var10 + var18.width + 5;
                  var1.method5541("Remember username", var10, var6 + 13, 16776960, 0);
                  var10 = class78.field1112 + 24;
                  var18 = GrandExchangeOffer.method54(ScriptState.preferences.hideUsername, class78.field1131);
                  var18.method5873(var10, var6);
                  var10 = var10 + var18.width + 5;
                  var1.method5541("Hide username", var10, var6 + 13, 16776960, 0);
                  var7 = var6 + 15;
                  int var20 = class78.field1112 - 80;
                  short var21 = 321;
                  class78.field1113.method5873(var20 - 73, var21 - 20);
                  var0.drawTextCentered("Login", var20, var21 + 5, 16777215, 0);
                  var20 = class78.field1112 + 80;
                  class78.field1113.method5873(var20 - 73, var21 - 20);
                  var0.drawTextCentered("Cancel", var20, var21 + 5, 16777215, 0);
                  var6 = 357;
                  var1.drawTextCentered("Forgotten your password? <col=ffffff>Click here.", class78.field1112, var6, 16776960, 0);
               } else if (class78.loginIndex == 3) {
                  var6 = 201;
                  var0.drawTextCentered("Invalid username or password.", class78.loginWindowX + 180, var6, 16776960, 0);
                  var7 = var6 + 20;
                  var1.drawTextCentered("For accounts created after 24th November 2010, please use your", class78.loginWindowX + 180, var7, 16776960, 0);
                  var7 += 15;
                  var1.drawTextCentered("email address to login. Otherwise please login with your username.", class78.loginWindowX + 180, var7, 16776960, 0);
                  var7 += 15;
                  var4 = class78.loginWindowX + 180;
                  var9 = 276;
                  class78.field1113.method5873(var4 - 73, var9 - 20);
                  var2.drawTextCentered("Try again", var4, var9 + 5, 16777215, 0);
                  var4 = class78.loginWindowX + 180;
                  var9 = 326;
                  class78.field1113.method5873(var4 - 73, var9 - 20);
                  var2.drawTextCentered("Forgotten password?", var4, var9 + 5, 16777215, 0);
                  ...
                  var0.drawTextCentered(class78.loginMessage3, class78.loginWindowX + 180, var7, 16777215, 0);
                  var7 += 15;
                  var0.method5541("PIN: " + TextureProvider.method2592(GameEngine.field414) + (Client.gameCycle % 40 < 20 ? class50.getColTags(16776960) + "|" : ""), class78.loginWindowX + 180 - 108, var7, 16777215, 0);
                  var7 -= 8;
                  var0.method5541("Trust this computer", class78.loginWindowX + 180 - 9, var7, 16776960, 0);
                  var7 += 15;
                  var0.method5541("for 30 days: ", class78.loginWindowX + 180 - 9, var7, 16776960, 0);
                  var4 = 180 + class78.loginWindowX - 9 + var0.getTextWidth("for 30 days: ") + 15;
                  int var17 = var7 - var0.verticalSpace;
                  IndexedSprite var12;
                  ...
                  var12.method5873(var4, var17);
                  var7 += 15;
                  int var13 = class78.loginWindowX + 180 - 80;
                  short var14 = 321;
                  class78.field1113.method5873(var13 - 73, var14 - 20);
                  var0.drawTextCentered("Continue", var13, var14 + 5, 16777215, 0);
                  var13 = class78.loginWindowX + 180 + 80;
                  class78.field1113.method5873(var13 - 73, var14 - 20);
                  var0.drawTextCentered("Cancel", var13, var14 + 5, 16777215, 0);
                  var1.drawTextCentered("<u=ff>Can't Log In?</u>", class78.loginWindowX + 180, var14 + 36, 255, 0);
                  ...
                  if (class78.loginIndex == 6) {
                     ...
                     var9 = 321;
                     class78.field1113.method5873(var4 - 73, var9 - 20);
                     var0.drawTextCentered("Back", var4, var9 + 5, 16777215, 0);
                  } else if (class78.loginIndex == 7) {
                     var6 = 216;
                     var0.drawTextCentered("Your date of birth isn't set.", class78.loginWindowX + 180, var6, 16776960, 0);
                     var7 = var6 + 15;
                     var2.drawTextCentered("Please verify your account status by", class78.loginWindowX + 180, var7, 16776960, 0);
                     var7 += 15;
                     var2.drawTextCentered("setting your date of birth.", class78.loginWindowX + 180, var7, 16776960, 0);
                     var7 += 15;
                     var4 = class78.loginWindowX + 180 - 80;
                     var9 = 321;
                     class78.field1113.method5873(var4 - 73, var9 - 20);
                     var0.drawTextCentered("Set Date of Birth", var4, var9 + 5, 16777215, 0);
                     var4 = class78.loginWindowX + 180 + 80;
                     class78.field1113.method5873(var4 - 73, var9 - 20);
                     var0.drawTextCentered("Back", var4, var9 + 5, 16777215, 0);
                  } else if (class78.loginIndex == 8) {
                     var6 = 216;
                     var0.drawTextCentered("Sorry, but your account is not eligible to play.", class78.loginWindowX + 180, var6, 16776960, 0);
                     var7 = var6 + 15;
                     var2.drawTextCentered("For more information, please take a look at", class78.loginWindowX + 180, var7, 16776960, 0);
                     var7 += 15;
                     var2.drawTextCentered("our privacy policy.", class78.loginWindowX + 180, var7, 16776960, 0);
                     var7 += 15;
                     var4 = class78.loginWindowX + 180 - 80;
                     var9 = 321;
                     class78.field1113.method5873(var4 - 73, var9 - 20);
                     var0.drawTextCentered("Privacy Policy", var4, var9 + 5, 16777215, 0);
                     var4 = class78.loginWindowX + 180 + 80;
                     class78.field1113.method5873(var4 - 73, var9 - 20);
                     var0.drawTextCentered("Back", var4, var9 + 5, 16777215, 0);
                  }
                  ...
                  var6 = 221;
                  var2.drawTextCentered(class78.loginMessage1, class78.loginWindowX + 180, var6, 16776960, 0);
                  var7 = var6 + 15;
                  var2.drawTextCentered(class78.loginMessage2, class78.loginWindowX + 180, var7, 16776960, 0);
                  var7 += 15;
                  var2.drawTextCentered(class78.loginMessage3, class78.loginWindowX + 180, var7, 16776960, 0);
                  var7 += 15;
                  var7 += 14;
                  var0.method5541("Username/email: ", class78.loginWindowX + 180 - 145, var7, 16777215, 0);
                  var8 = 174;
                  ...
                  var0.method5541(FontTypeFace.appendTags(var15) + (Client.gameCycle % 40 < 20 ? class50.getColTags(16776960) + "|" : ""), class78.loginWindowX + 180 - 34, var7, 16777215, 0);
                  var7 += 15;
                  var10 = class78.loginWindowX + 180 - 80;
                  short var11 = 321;
                  class78.field1113.method5873(var10 - 73, var11 - 20);
                  var0.drawTextCentered("Recover", var10, var11 + 5, 16777215, 0);
                  var10 = class78.loginWindowX + 180 + 80;
                  class78.field1113.method5873(var10 - 73, var11 - 20);
                  var0.drawTextCentered("Back", var10, var11 + 5, 16777215, 0);
               }
            }
         }
         ...
         if (Client.gameState > 5 && Client.languageId == 0) {
            if (Occluder.field1844 != null) {
               var7 = class78.field1104 + 5;
               var8 = 463;
               byte var16 = 100;
               byte var19 = 35;
               Occluder.field1844.method5873(var7, var8);
               var0.drawTextCentered("World " + Client.world, var16 / 2 + var7, var19 / 2 + var8 - 2, 16777215, 0);
               if (World.listFetcher != null) {
                  var1.drawTextCentered("Loading...", var16 / 2 + var7, var19 / 2 + var8 + 12, 16777215, 0);
               } else {
                  var1.drawTextCentered("Click to switch", var16 / 2 + var7, var19 / 2 + var8 + 12, 16777215, 0);
               }
            } else {
