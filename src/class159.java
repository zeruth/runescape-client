...
public class class159 extends class157 {
   ...
   class159(Socket var1, int var2, int var3) throws IOException {
      ...
      this.field2005 = new class163(this.field2003.getOutputStream(), var3);
   }
   ...
   public void vmethod3385(byte[] var1, int var2, int var3) throws IOException {
      this.field2005.method3404(var1, var2, var3);
   }
   ...
   static void method3345(int var0, int var1, int var2, int var3) {
      class53 var4 = (class53)class53.field478.method4064((long)var0);
      if(var4 == null) {
         var4 = new class53();
         class53.field478.method4063(var4, (long)var0);
      }

      if(var4.field482.length <= var1) {
         int[] var5 = new int[var1 + 1];
         int[] var6 = new int[var1 + 1];

         int var7;
         for(var7 = 0; var7 < var4.field482.length; ++var7) {
            var5[var7] = var4.field482[var7];
            var6[var7] = var4.field480[var7];
         }

         for(var7 = var4.field482.length; var7 < var1; ++var7) {
            var5[var7] = -1;
            var6[var7] = 0;
         }
      ...
      var4.field482[var1] = var2;
      var4.field480[var1] = var3;
   }
}
