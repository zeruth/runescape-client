...
public final class SpritePixels extends Rasterizer2D {
   ...
   public void method5911(int var1, int var2, int var3, int var4, int var5, int var6, int[] var7, int[] var8) {
      ...
      for(int var15 = var9; var15 < var10; ++var15) {
         ...
         for(int var21 = var19; var21 < var20; ++var21) {
            int var22 = this.pixels[var21 + var15 * this.width];
            if (var22 != 0) {
   ...
   @ObfuscatedName("ag")
   public void method5948(int param1, int param2, int param3, int param4, int param5, int param6, int param7, int param8, int[] param9, int[] param10) {
      // $FF: Couldn't be decompiled
   }

   @ObfuscatedName("ah")
   public void method5913(int param1, int param2, int param3, int param4, int param5, int param6, double param7, int param9) {
      // $FF: Couldn't be decompiled
   }
