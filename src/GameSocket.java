         ...
         while(true) {
            ...
            try {
               if(var1 + this.field2039 <= this.field2035) {
                  ...
                  int var2 = this.field2035 - this.field2039;
                  this.field2031.write(this.field2033, this.field2039, var2);
                  this.field2031.write(this.field2033, 0, var1 - var2);
               }
            } catch (IOException var13) {
               IOException var3 = var13;
               synchronized(this) {
                  this.field2034 = var3;
                  return;
               }
