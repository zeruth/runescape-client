...
public class CacheFile {
   ...
   public void read(byte[] var1, int var2, int var3) throws IOException {
      try {
         ...
         if(this.position >= this.field1443 && this.position < (long)this.field1450 + this.field1443) {
            var7 = (int)((long)this.field1450 - (this.position - this.field1443));
            if(var7 > var3) {
               var7 = var3;
            }

            System.arraycopy(this.readPayload, (int)(this.position - this.field1443), var1, var2, var7);
         ...
         if(var3 > this.readPayload.length) {
            ...
            for(this.field1444 = this.position; var3 > 0; var3 -= var7) {
               var7 = this.accessFile.read(var1, var2, var3);
               if(var7 == -1) {
                  break;
               }

               this.field1444 += (long)var7;
               this.position += (long)var7;
               var2 += var7;
            }
         } else if(var3 > 0) {
         ...
         if(-1L != this.field1445) {
            if(this.field1445 > this.position && var3 > 0) {
               var7 = var2 + (int)(this.field1445 - this.position);
               if(var7 > var3 + var2) {
                  var7 = var3 + var2;
               }
            ...
            long var8 = -1L;
            long var10 = -1L;
            if(this.field1445 >= var4 && this.field1445 < (long)var6 + var4) {
               var8 = this.field1445;
            } else if(var4 >= this.field1445 && var4 < this.field1445 + (long)this.field1447) {
               var8 = var4;
            }

            if((long)this.field1447 + this.field1445 > var4 && (long)this.field1447 + this.field1445 <= (long)var6 + var4) {
               var10 = (long)this.field1447 + this.field1445;
            } else if((long)var6 + var4 > this.field1445 && var4 + (long)var6 <= this.field1445 + (long)this.field1447) {
               var10 = var4 + (long)var6;
            }

            if(var8 > -1L && var10 > var8) {
               int var12 = (int)(var10 - var8);
               System.arraycopy(this.writePayload, (int)(var8 - this.field1445), var1, (int)(var8 - var4) + var2, var12);
      ...
      try {
         ...
         if(var3 <= this.writePayload.length) {
            ...
            if(var10 > -1L && var6 > var10) {
               ...
               System.arraycopy(var1, (int)(var10 + (long)var2 - this.position), this.readPayload, (int)(var10 - this.field1443), var8);
            }
   ...
   static void method2549() {
      ...
      PacketNode var4 = DecorativeObject.method3115(ClientPacket.field2206, Client.field739.field1250);
      PacketBuffer var2 = var4.packetBuffer;
      int var3 = Client.isResized?2:1;
      var2.putByte(var3);
      var4.packetBuffer.putShort(class9.canvasWidth);
      var4.packetBuffer.putShort(class37.canvasHeight);
