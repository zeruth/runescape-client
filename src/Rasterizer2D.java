      ...
      if(var2 > 0 && var3 > 0) {
         ...
         for(int var17 = 0; var17 < var3; ++var17) {
            ...
            for(var18 = -var2; var18 < 0; ++var18) {
               ...
               graphicsPixels[var16++] = var25 + (var24 << 8) + (var23 << 16);
            }
            ...
            if(var9 > 0) {
               ...
               if(var5 != var4) {
                  var20 = (var19 * (var5 & 16711935) + var18 * (var4 & 16711935) & -16711936) + (var19 * (var5 & 65280) + var18 * (var4 & 65280) & 16711680) >>> 8;
                  var12 = var20 >> 16;
                  var13 = (var20 & 65280) >> 8;
                  var14 = var20 & 255;
               }
