...
public class ChatLineBuffer {
   ...
   public static SpritePixels getSpriteAsSpritePixels(IndexDataBase var0, int var1, int var2) {
      if(!class306.method5702(var0, var1, var2)) {
         ...
         var3.maxWidth = class319.indexedSpriteWidth;
         var3.maxHeight = class275.indexedSpriteHeight;
         var3.offsetX = class319.indexedSpriteOffsetXs[0];
         var3.offsetY = class319.indexedSpriteOffsetYs[0];
         var3.width = class192.indexSpriteWidths[0];
         var3.height = class319.indexedSpriteHeights[0];
         int var4 = var3.height * var3.width;
         byte[] var5 = class294.spritePixels[0];
         var3.pixels = new int[var4];

         for(int var6 = 0; var6 < var4; ++var6) {
            var3.pixels[var6] = class319.indexedSpritePalette[var5[var6] & 255];
         }
