...
public final class Player extends Actor {
   ...
   final void decodeApperance(Buffer var1) {
      ...
      for(int var7 = 0; var7 < 12; ++var7) {
         ...
         if (var5 == 0) {
            ...
            if (var4[var7] >= 512) {
               int var8 = class120.getItemDefinition(var4[var7] - 512).team;
               if (var8 != 0) {
                  this.team = var8;
               }
            }
      ...
      for(var5 = 0; var5 < 5; ++var5) {
         var6 = var1.readUnsignedByte();
         if (var6 < 0 || var6 >= class185.colorsToReplace[var5].length) {
            var6 = 0;
         }
   ...
   protected final Model getModel() {
      if (this.composition == null) {
         ...
         Sequence var2 = super.poseAnimation == -1 || this.isLowDetail || super.idlePoseAnimation == super.poseAnimation && var1 != null ? null : class137.getAnimation(super.poseAnimation);
   ...
   static final void method1178(int var0, int var1) {
      if ((Client.menuOptionCount >= 2 || Client.itemSelectionState != 0 || Client.spellSelected) && Client.field740) {
         ...
         if (Client.itemSelectionState == 1 && Client.menuOptionCount < 2) {
            ...
            var3 = Client.field750 + " " + Client.field751 + " " + "->";
         } else {
            var3 = class234.method4595(var2);
         }

         if (Client.menuOptionCount > 2) {
            var3 = var3 + class50.getColTags(16777215) + " " + '/' + " " + (Client.menuOptionCount - 2) + " more options";
         }

         WidgetNode.fontBold12.drawRandomizedMouseoverText(var3, var0 + 4, var1 + 15, 16777215, 0, Client.gameCycle / 1000);
      }
