...
public final class KeyFocusListener implements KeyListener, FocusListener {
   ...
   @Export("keyboard")
   public static KeyFocusListener keyboard = new KeyFocusListener();
   @ObfuscatedName("a")
   @ObfuscatedSignature(
      signature = "Liv;"
   )
   ...
   @ObfuscatedName("co")
   @Export("keyPressed")
   public static boolean[] keyPressed = new boolean[112];
   @ObfuscatedName("ck")
   public static int[] field341 = new int[128];
   @ObfuscatedName("ca")
   @ObfuscatedGetter(
      intValue = 1378128227
   )
   ...
   @ObfuscatedName("cb")
   static char[] field344 = new char[128];
   @ObfuscatedName("cg")
   static int[] field339 = new int[128];
   @ObfuscatedName("cl")
   ...
   static final void method761(boolean var0) {
      if (var0) {
         ...
         Client.field716 = ScriptState.preferences.preferences.containsKey(Client.method1577(class78.username)) ? class146.field1930 : class146.field1929;
      }
