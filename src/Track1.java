...
public class Track1 extends Node {
   ...
   void method4450() {
      if (this.field2568 == null) {
         ...
         var2[9] = 128;
         var1[9] = 128;
         class220 var3 = new class220(this.field2569);
         int var4 = var3.method4367();

         int var5;
         for(var5 = 0; var5 < var4; ++var5) {
            var3.method4411(var5);
            var3.method4371(var5);
         ...
         do {
            while(true) {
               var5 = var3.method4409();
               int var6 = var3.field2541[var5];
