         ...
         try {
            if(class250.field3209 > 30000) {
               ...
               for(int var5 = 0; var5 < 100; ++var5) {
                  int var6 = class250.NetCache_socket.vmethod3354();
                  if(var6 < 0) {
                     throw new IOException();
                  }
                  ...
                  if(var7 > 0) {
                     ...
                     class250.NetCache_socket.vmethod3356(class250.NetCache_responseHeaderBuffer.payload, class250.NetCache_responseHeaderBuffer.offset, var8);
                     if(class250.field3225 != 0) {
                        for(var9 = 0; var9 < var8; ++var9) {
                           class250.NetCache_responseHeaderBuffer.payload[class250.NetCache_responseHeaderBuffer.offset + var9] ^= class250.field3225;
                        }
                     }
                     ...
                     if(class320.currentRequest == null) {
                        ...
                        int var12 = class250.NetCache_responseHeaderBuffer.readUnsignedByte();
                        var11 = class250.NetCache_responseHeaderBuffer.readInt();
                        ...
                        class320.currentRequest = var15;
                        class232.NetCache_responseArchiveBuffer = new Buffer(var16 + var11 + class320.currentRequest.padding);
                        class232.NetCache_responseArchiveBuffer.putByte(var12);
                        class232.NetCache_responseArchiveBuffer.putInt(var11);
                     ...
                     var8 = class232.NetCache_responseArchiveBuffer.payload.length - class320.currentRequest.padding;
                     var9 = 512 - class250.field3221;
                     if(var9 > var8 - class232.NetCache_responseArchiveBuffer.offset) {
                        var9 = var8 - class232.NetCache_responseArchiveBuffer.offset;
                     }
                     ...
                     class250.NetCache_socket.vmethod3356(class232.NetCache_responseArchiveBuffer.payload, class232.NetCache_responseArchiveBuffer.offset, var9);
                     if(class250.field3225 != 0) {
                        for(var10 = 0; var10 < var9; ++var10) {
                           class232.NetCache_responseArchiveBuffer.payload[class232.NetCache_responseArchiveBuffer.offset + var10] ^= class250.field3225;
                        }
                     }

                     class232.NetCache_responseArchiveBuffer.offset += var9;
                     class250.field3221 += var9;
                     if(var8 == class232.NetCache_responseArchiveBuffer.offset) {
                        if(16711935L == class320.currentRequest.hash) {
                           class325.NetCache_reference = class232.NetCache_responseArchiveBuffer;

                           for(var10 = 0; var10 < 256; ++var10) {
                              IndexData var20 = class250.NetCache_indexCaches[var10];
                              if(var20 != null) {
                                 class325.NetCache_reference.offset = var10 * 8 + 5;
                                 var11 = class325.NetCache_reference.readInt();
                                 int var21 = class325.NetCache_reference.readInt();
                                 var20.setInformation(var11, var21);
                              }
                           }
                        } else {
                           class250.NetCache_crc.reset();
                           class250.NetCache_crc.update(class232.NetCache_responseArchiveBuffer.payload, 0, var8);
                           var10 = (int)class250.NetCache_crc.getValue();
                           if(var10 != class320.currentRequest.crc) {
                              try {
