...
public class RenderOverview {
      ...
      if (this.field3833.method6035()) {
         ...
         if (var3) {
            ...
            for(var12 = var10.iterator(); var12.hasNext(); FriendManager.method1728(var14)) {
               ...
               var14.method1078(new Object[]{var15, var1, var2});
   ...
   public void extractWorldmap(int var1, int var2, int var3, int var4, int var5) {
      ...
      if (var7 < 100) {
         ...
         if (!this.field3819) {
            ...
            this.worldMapManager.drawMapIcons(this.worldMapX - var8 / 2, this.worldMapY - var9 / 2, var8 / 2 + this.worldMapX, var9 / 2 + this.worldMapY, var1, var2, var3 + var1, var2 + var4, this.field3861, this.field3847, this.field3849, this.field3845, var10);
         }
   ...
   public void setWorldMapPositionTarget(int var1, int var2) {
      if (this.worldMapData != null && this.worldMapData.surfaceContainsPosition(var1, var2)) {
         this.worldMapTargetX = var1 - this.worldMapData.getMinX() * 64;
         this.worldMapTargetY = var2 - this.worldMapData.getMinY() * 64;
      }
   ...
   public void method6090(int var1) {
      ...
      for(int var2 = 0; var2 < Area.mapAreaType.length; ++var2) {
         if (Area.mapAreaType[var2] != null && Area.mapAreaType[var2].field3277 == var1) {
            this.field3847.add(Area.mapAreaType[var2].id);
         }
      }
   ...
   public void method6095(int var1, boolean var2) {
      if (!var2) {
         this.field3863.add(var1);
      } else {
         this.field3863.remove(var1);
      }
   ...
   public void method6082(int var1, boolean var2) {
      if (!var2) {
         this.field3859.add(var1);
      } else {
         this.field3859.remove(var1);
      }
      ...
      for(int var3 = 0; var3 < Area.mapAreaType.length; ++var3) {
         if (Area.mapAreaType[var3] != null && Area.mapAreaType[var3].field3277 == var1) {
            ...
            if (!var2) {
               this.field3860.add(var4);
            } else {
               this.field3860.remove(var4);
            }
         }
      }
   ...
   public boolean method6098(int var1) {
      return !this.field3863.contains(var1);
   }
   ...
   public boolean method6059(int var1) {
      return !this.field3859.contains(var1);
   }
      ...
      if (this.field3833.method6035()) {
         ...
         if (!var9.isEmpty()) {
            ...
            do {
               ...
               MapIcon var12 = (MapIcon)var10.next();
               Area var13 = Area.mapAreaType[var12.areaId];
               var11 = false;

               for(int var14 = this.field3864.length - 1; var14 >= 0; --var14) {
                  if (var13.field3266[var14] != null) {
                     VertexNormal.addMenuEntry(var13.field3266[var14], var13.field3270, this.field3864[var14], var12.areaId, var12.field253.bitpack(), var12.field247.bitpack());
                     var11 = true;
                  }
               }
            } while(!var11);
   ...
   public Coordinates method6105(int var1, Coordinates var2) {
      if (!this.field3833.method6035()) {
         ...
         if (var4 != null && !var4.isEmpty()) {
            ...
            while(var7.hasNext()) {
               MapIcon var8 = (MapIcon)var7.next();
               int var10 = var8.field247.worldX - var2.worldX;
               int var11 = var8.field247.worldY - var2.worldY;
